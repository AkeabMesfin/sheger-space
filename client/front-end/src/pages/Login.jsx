    ...
    return (
        <div className="flex flex-col w-full h-full p-8 gap-8 overflow-auto">
            ...
            <div className='w-full h-full flex flex-wrap justify-evenly items-center gap-8 '>
                ...
                <div className='bg-white flex flex-col p-7 gap-5 rounded-[28px] max-w-[300px] w-full '>
                    ...
                    <form className='flex flex-col gap-4 text-(--text)' onSubmit={(e) => handleLogin(e, email, password) }>

                        <Input placeholder={"Email"} type={"Email"} name={"email"} className="input primary" onChange={(e) => setEmail(e.target.value)}/>

                        <Input placeholder={"Password"} type={"Password"} name={"password"} className="input primary" onChange={(e) => setPassword(e.target.value)}/>
                        ...
                        <div>
                            ...
                            <p>
                                ...
                                <Button text={"Sign-up"} className={"btn link text-(--accent)"}/>
                            ...
                            <p>
                                ...
                                <Button text={"Reset"} className={"btn link text-(--accent)"}/>
